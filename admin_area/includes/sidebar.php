...
<i class="fa fa-fw fa-list"></i> View Users
...
<i class="fa fa-fw fa-pencil"></i> View Doctors
...
<i class="fa fa-fw fa-pencil"></i> View Appointments
...
<li>
<a href="index.php?view_admins"> View Admin </a>
</li>

<li>
<a href="index.php?user_profile=<?php echo $admin_id; ?>"> Edit Admin </a>
</li>
