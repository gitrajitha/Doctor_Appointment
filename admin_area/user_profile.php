...
$update_admin = "update admin set name='$admin_name',email='$admin_email',pass='$admin_pass',country = '$admin_country',image='$admin_image',contact='$admin_contact',job='$admin_job',about='$admin_about' where id='$admin_id'";
