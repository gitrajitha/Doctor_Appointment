...
$insert_admin = "insert into admin (name,email,pass,image,contact,country,job,about) values ('$admin_name','$admin_email','$admin_pass','$admin_image','$admin_contact','$admin_country','$admin_job','$admin_about')";
